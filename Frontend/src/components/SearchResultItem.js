...
function SearchResultItem(props) {
  ...
  const ariaLabelItem =
    "Item: " + item.title + ". Precio: " + item.price.amount;
  const imageSrc = item.picture
    ? item.picture
    : require("../assets/images/picture_not_found.svg");
  return (
    <article className="item section-results__item">
      ...
      <div className="section-results__item__data-container">
        ...
        >
          ...
          {item.free_shipping ? (
            <span
              className="icon section-results__item__free-shipping-icon item__free-shipping-icon"
              title="Envío gratis"
        ...
        >
          <h2
            className="section-results__item__title item__title"
