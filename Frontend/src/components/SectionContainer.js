...
import SearchResultSection from "./SearchResultSection.js";
import ItemDetailSection from "./ItemDetailSection.js";
          ...
          <Route
            ...
            render={(props) => (
              <MessageSection
                {...props}
                imageUrl={null}
                message="¡Bienvenido, empieza a buscar lo que quieras!"
              />
            )}
          />
          <Route
            ...
            render={(routeProps) => (
              <SearchResultSection
                {...routeProps}
                items={props.items}
                handleSearchItems={props.handleSearchItems}
              />
            )}
          />
          <Route
            ...
            render={(routeProps) => (
              <ItemDetailSection
                ...
                handleItemChanged={props.handleItemChanged}
              />
            )}
          />
          <Route
